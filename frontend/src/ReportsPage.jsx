...
export default function ReportsPage() {
  ...
  const cards = [
    ...
    ['মোট লাভ', financial.totalProfit],
    ['মোট ক্ষতি', financial.totalLoss],
    ['ডেলিভারি হয়েছে', financial.deliveredCount],
  ...
  return (
    <>
      <PageHeader
        icon={FileText}
        title="রিপোর্টস"
        subtitle="সম্পূর্ণ আর্থিক ও ইনভেন্টরি বিশ্লেষণ"
        action={
        ...
        {cards.map(([label, value]) => (
          <div className="stat-card" key={label}>
            <div>
              ...
              <strong>
                {label.includes('হয়েছে') || label.includes('অর্ডার')
                  ? value
                  : `৳ ${value.toFixed(2)}`}
              </strong>
            </div>
      ...
      <section className="panel filter-panel">
        <div>
          <h3>ফিল্টার রিপোর্ট</h3>
          <p>তারিখ অনুযায়ী রিপোর্ট দেখুন</p>
        </div>
        <div className="filter-fields">
          <FormField label="তারিখ থেকে">
            <input type="date" value={range.from} onChange={e => setRange({ ...range, from: e.target.value })} />
          </FormField>
          <FormField label="তারিখ পর্যন্ত">
            ...
            <tbody>
              {orders.map(o => (
                <tr key={o._id}>
                  ...
                  <td>{o.product_type} (x{o.quantity})</td>
      ...
      <section className="panel table-panel">
        <div className="panel-head">
          <h3><Package size={17} /> ইনভেন্টরি ভ্যালুয়েশন (FIFO)</h3>
        </div>
        <div className="table-wrap">
          <table>
            <thead>
            ...
            <tbody>
              {valuation.map(i => (
                <tr key={i.product_name}>
                  ...
                  <td><b>৳ {i.total_value.toFixed(2)}</b></td>
                </tr>
              ))}
            </tbody>
          </table>
